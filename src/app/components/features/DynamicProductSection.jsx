    ...
    <section className="py-4 mb-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6">
          <Link
            href="/produkter"
            className="inline-flex items-center text-gray-600 hover:text-black hover:underline transition-colors"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            {/* Main Image */}
            <div className="aspect-square bg-white rounded-md overflow-hidden border relative">
              <Image
            ...
            <div className="flex gap-3">
              {product.images.map((image, index) => (
                <button
                  ...
                  className={`aspect-square w-20 h-20 rounded-md overflow-hidden border transition-colors relative ${
                    selectedImage === index
                      ? "border-black"
                    ...
                    <div>
                      ...
                      <p className="text-black text-sm leading-relaxed">
                        {product.category === "private"
                          ...
                          : "Erhvervsdragten"}{" "}
                        er udstyret med{" "}
                        <strong>{product.muscleCoverage.pads} pads</strong>,
                        strategisk placeret på kroppens store muskelgrupper.
                      </p>
                    </div>
                      ...
                      <div>
                        ...
                        <ul className="accordion-list space-y-1">
                          ...
                          <li>
                            ...
                            {product.businessFeatures.support}
                          </li>
                          <li>
                            <strong>Træning:</strong>{" "}
                            {product.businessFeatures.training}
                          </li>
                          <li>
                            <strong>Vedligeholdelse:</strong>{" "}
                            {product.businessFeatures.maintenance}
                          </li>
                        </ul>
                      </div>
                    )}
                    ...
                    <ul className="accordion-list space-y-2">
                      ...
                      {product.shipping.freeShippingThreshold > 0 ? (
                        <li className="flex justify-between items-center py-2 border-b border-gray-100">
                          ...
                          <span className="text-black text-sm">
                            Gratis fragt ved køb over{" "}
                            {product.shipping.freeShippingThreshold} kr.
                          </span>
                        </li>
                      ) : (
                        <li className="flex justify-between items-center py-2 border-b border-gray-100">
                      ...
                      <li className="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <span className="text-black text-sm">
                          Hurtig kundeservice hvis der opstår problemer
                        </span>
                      </li>
                      {product.shipping.installationService && (
                        <li className="flex justify-between items-center py-2 border-b border-gray-100">
                          ...
                          <span className="text-black text-sm">
                            Professionel installationsservice tilgængelig
                          </span>
                        </li>
                      )}
                    </ul>
